...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: {
    ...
    { path: "/products/forge", priority: 0.9, cf: "weekly" },
    { path: "/products/sattvah", priority: 0.9, cf: "weekly" },
    { path: "/labs", priority: 0.8, cf: "monthly" },
    { path: "/trust", priority: 0.7, cf: "monthly" },
    { path: "/press", priority: 0.7, cf: "monthly" },
    { path: "/careers", priority: 0.6, cf: "monthly" },
    { path: "/contact", priority: 0.7, cf: "monthly" },
    { path: "/coaches", priority: 0.8, cf: "weekly" },
    { path: "/community", priority: 0.7, cf: "daily" },
